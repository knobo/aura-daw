...
```sh
cd src-tauri && cargo test   # 797 tests (763 lib + 34 integration, plus 2 #[ignore]d plugin repros; counted 2026-08-15 on plan-f-history; re-measure after merging main + Track F)
