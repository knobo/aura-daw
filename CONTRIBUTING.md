...
```sh
cd src-tauri && cargo test   # 887 tests (853 lib + 34 integration, plus 2 #[ignore]d plugin repros; counted 2026-08-16 after merging main + Track F onto plan-f-history)
