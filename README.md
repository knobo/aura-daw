...
```sh
cd src-tauri && cargo test    # 295 tests (counted 2026-08-13): engine, MIDI, sampler, plugins, MCP, sidecars, control plane
npm test                      # 17 frontend unit tests (counted 2026-08-13; vitest): stores + timeline math
