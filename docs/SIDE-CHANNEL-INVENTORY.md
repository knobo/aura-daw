...
| 13 | `plugin_set_param` — project.json rewritten per knob gesture | `Op::Set{Plugin, Param{index}}` + host-forward effect + `PersistEffect` | `src-tauri/src/plugins/mod.rs:353`; op arm `src-tauri/src/control/session.rs:894` |
