...
|---|---|---|---|
| Playback CPU: GC, blur, raster | `perf/playback-cpu` | 2026-08-30 | Follow-up to #133/#134. Playback sits at ~97% web-process CPU; perf says GC 32%, CPU blur 4.7%, Skia raster+upload 20%. Experiments only so far. |
