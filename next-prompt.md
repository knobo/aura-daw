...
take Pitch Coach (PR #54 is in flight).

**In flight:** PR #54 pitch RT (other owner). Stale worktrees for
...
| Pitch Coach phase 1 | PR #49 `84b0313`. Next: owner ear-check (R3), then phase 2 panel. [`pitch-coach-PROGRESS.md`](docs/superpowers/plans/2026-08-16-pitch-coach-PROGRESS.md) |
...
- **Owner ear-checks** (no suite substitutes): automation fade during play (Track D); MIDI note-out / Hydrogen / keyboard record (Track B); Pitch Coach R3 listen + sing. Insert FX is not ear-checkable until Task 5 lands.
