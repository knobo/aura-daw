...
pub fn run() {
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            audio::sampler_preview_note_on,
            audio::sampler_preview_note_off,
            ...
            midi::launch::launch_set_quantize,
            ...
            plugins::plugin_preview_note,
            plugins::plugin_preview_note_on,
            plugins::plugin_preview_note_off,
            plugins::plugin_show_gui,
            plugins::plugin_set_gui_on_top,
            plugins::insert_add,
